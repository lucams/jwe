...
public class ApacheConnection {
	private static final Logger logger = Logger.getLogger(ApacheConnection.class);
	...
	public String executeSSLGet(String URLAddress, Map<String,String> headerParams) throws MalformedURLException, IOException, KeyManagementException, NoSuchAlgorithmException, KeyStoreException {
